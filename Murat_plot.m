...
SetFDefaults()
%%
% Then it shows the peak delay relative to the ray length, in the second subplot.
subplot(2,1,2)
...
%% PLOT - SPIKES
% In this section Murat_plot shows input and output of the spike tests for Q 
% and Qc.
