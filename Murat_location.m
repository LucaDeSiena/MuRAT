...
even                        =   [SAChdr_i.event.evlo...
    SAChdr_i.event.evla SAChdr_i.event.evdp];

% Station info from file
stati                       =   [SAChdr_i.station.stlo...
    SAChdr_i.station.stla SAChdr_i.station.stel];
...
% Variable to process in ray tracing
...
sst_i                       = [dist_x_even dist_y_even dist_z_even...
