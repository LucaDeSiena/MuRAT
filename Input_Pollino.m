...
% Get name of files in current folder of traces
list = dir(DFolder);
...
if evst==1
    ...
    % UTM coordinates of the origin of the model - for Mount Saint Helens
...
if pa==3
    ...
    %Create grid for direct waves and check for zeroes
